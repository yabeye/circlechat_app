        ...
        builder: (context, state) {
          ...
          return AppScaffold(
            ...
            body: CustomScrollView(
              slivers: [
                SliverToBoxAdapter(child: AppSizes.verticalPaddingMin),
                SliverList(
                          ...
                          (BuildContext context, int index) {
                            ...
                            return AppListTile(
                              ...
                              title: isMyContact
                                  ...
                                  : contact.name,
                              titleStyle: ThemeUtils.chatListTileTitleTextStyle(
                                context,
                              ),
                ...
                (state is ContactsLoading)
                    ...
                    : (state is ContactsPermissionDenied)
                        ...
                        : SliverList(
                            delegate: SliverChildBuilderDelegate(
                              (BuildContext context, int index) {
                                final groupedContacts = groupContacts(contacts);
                                ...
                                for (final initial in initials) {
                                  ...
                                  final contactList = groupedContacts[initial]!;
                                  if (index >= currentItemIndex &&
                                      index <
                                          currentItemIndex +
                                              contactList.length) {
                              ...
                              childCount: groupContacts(contacts).keys.fold(
                                  ...
                                  (count, initial) =>
                                      (count ?? 0) +
                                      1 +
                                      groupContacts(contacts)[initial]!.length),
                            ),
                          ),
              ],
            ),
